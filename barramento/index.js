...
app.put("/cadastro", (req, res) => {    /*Atualização do banco de dados*/
    const Atualize = req.body;
    axios.put('http://localhost:3000', Atualize);
    res.status(200).send({msg: "Usuario cadastrado!"});
})
app.listen(5000, () => {
